...
[![Build Status](https://github.com/varsha-raveendran/deeplearning_pkg/workflows/Build%20Master/badge.svg)](https://github.com/varsha-raveendran/deeplearning_pkg/actions)
[![Documentation](https://github.com/varsha-raveendran/deeplearning_pkg/workflows/Documentation/badge.svg)](https://varsha-raveendran.github.io/deeplearning_pkg)
[![Code Coverage](https://codecov.io/gh/varsha-raveendran/deeplearning_pkg/branch/master/graph/badge.svg)](https://codecov.io/gh/varsha-raveendran/deeplearning_pkg)

A Python package contains methods to train a deep learning model
...
## Quick Start
```python
from deeplearning_pkg import Example
...
## Installation
**Stable Release:** `pip install deeplearning_pkg`<br>
**Development Head:** `pip install git+https://github.com/varsha-raveendran/deeplearning_pkg.git`

## Documentation
For full package documentation please visit [varsha-raveendran.github.io/deeplearning_pkg](https://varsha-raveendran.github.io/deeplearning_pkg).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:varsha-raveendran/deeplearning_pkg.git`
    * `git push -u origin master`
* Register deeplearning_pkg with Codecov:
  * Make an account on [codecov.io](https://codecov.io)
  (Recommended to sign in with GitHub)
  * Select `varsha-raveendran` and click: `Add new repository`
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/varsha-raveendran/deeplearning_pkg/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/varsha-raveendran/deeplearning_pkg/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/varsha-raveendran/deeplearning_pkg/settings/branches), click `Add rule` and select the
